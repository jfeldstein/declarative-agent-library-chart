...
- Numbered decisions start at **0001** and increase (e.g. `0001-use-python-for-runtime.md`, `0002-enforce-85-percent-test-coverage.md`, `0003-spec-test-traceability.md`, `0004-pin-atif-v1-4-trajectory-export.md`).
