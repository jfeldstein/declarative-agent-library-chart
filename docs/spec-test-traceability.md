...
| [DALC-REQ-JIRA-TRIGGER-001] | `openspec/specs/dalc-jira-trigger/spec.md` | `helm/src/tests/test_jira_trigger.py::test_jira_trigger_issue_updated_invokes_run_trigger_graph`, `helm/src/tests/test_jira_trigger.py::test_jira_trigger_event_dedupe_skips_second_delivery` | default PR | - | - |
