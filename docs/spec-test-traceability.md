...
| [DALC-REQ-TOKEN-MET-004] | `openspec/specs/dalc-runtime-token-metrics/spec.md` | `helm/src/hosted_agents/metrics.py`, `helm/src/hosted_agents/app.py`, `helm/src/tests/test_token_metrics.py::test_trigger_payload_histograms_record_request_size`, `helm/src/tests/test_token_metrics.py::test_trigger_payload_histograms_record_response_size` | default PR | - | - |
...
| [DALC-REQ-POSTGRES-AGENT-PERSISTENCE-004] | `openspec/specs/dalc-postgres-agent-persistence/spec.md` | `helm/src/tests/test_migrations_schema.py`, `helm/src/hosted_agents/migrations/001_hosted_agents_observability.sql`, `docs/runbook-checkpointing-wandb.md` | default PR | - | - |
...
| [DALC-REQ-SLACK-TOOLS-006] | `openspec/specs/dalc-slack-tools/spec.md` | `helm/src/tests/test_slack_tools_impl.py::test_slack_api_error_has_no_token_in_payload`, `helm/src/tests/test_slack_tools_impl.py::test_slack_req_id_from_headers_never_raises`, `helm/src/hosted_agents/metrics.py` | default PR | - | - |
| [DALC-REQ-JIRA-TOOLS-001] | `openspec/specs/dalc-jira-tools/spec.md` | `helm/src/tests/test_jira_tools.py::test_jira_tools_python_sources_avoid_embed_route`, `helm/src/tests/test_jira_tools.py::test_allowlisted_tool_ids_cover_runtime_surface`, `helm/src/hosted_agents/tools_impl/README.md` | default PR | - | - |
| [DALC-REQ-JIRA-TOOLS-002] | `openspec/specs/dalc-jira-tools/spec.md` | `helm/tests/hello_world_test.yaml`, `helm/chart/values.yaml`, `helm/chart/values.schema.json`, `helm/src/hosted_agents/tools_impl/README.md` | default PR | - | - |
...
| [DALC-REQ-SLACK-TRIGGER-005] | `openspec/specs/dalc-slack-trigger/spec.md` | `helm/src/tests/test_slack_trigger.py::test_slack_trigger_metrics_counter_has_no_secret_labels`, `helm/src/hosted_agents/metrics.py` | default PR | - | - |
...
| [DALC-REQ-JIRA-TRIGGER-002] | `openspec/specs/dalc-jira-trigger/spec.md` | `helm/src/tests/test_jira_trigger.py::test_jira_trigger_sources_do_not_reference_embed_route`, `helm/src/tests/test_jira_trigger.py::test_jira_tools_can_coexist_with_trigger_runtime_paths`, `helm/src/hosted_agents/jira_trigger/README.md` | default PR | - | - |
...
| [DALC-REQ-JIRA-TRIGGER-004] | `openspec/specs/dalc-jira-trigger/spec.md` | `helm/tests/hello_world_test.yaml`, `helm/chart/values.yaml`, `helm/chart/values.schema.json`, `helm/src/hosted_agents/jira_trigger/README.md` | default PR | - | - |
| [DALC-REQ-JIRA-TRIGGER-005] | `openspec/specs/dalc-jira-trigger/spec.md` | `helm/src/tests/test_jira_trigger.py::test_jira_trigger_metrics_counter_has_no_secret_labels`, `helm/src/hosted_agents/metrics.py` | default PR | - | - |
