...
### Requirement: [CFHA-REQ-JIRA-TOOLS-001] Jira tools operate during agent invocation and do not ingest tool I/O into managed RAG by default
...
### Requirement: [CFHA-REQ-JIRA-TOOLS-002] Jira tools credentials are distinct from Jira scraper credentials
...
### Requirement: [CFHA-REQ-JIRA-TOOLS-003] Agent can read and mutate issues within configured scopes
...
### Requirement: [CFHA-REQ-JIRA-TOOLS-004] Agent can run bounded JQL or issue search
...
### Requirement: [CFHA-REQ-JIRA-TOOLS-005] Jira REST access uses httpx consistent with repository dependency policy
...
### Requirement: [CFHA-REQ-JIRA-TOOLS-006] Secrets are never written to logs or metrics labels on the tools path
