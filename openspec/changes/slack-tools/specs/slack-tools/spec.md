...
### Requirement: [CFHA-REQ-SLACK-TOOLS-001] Slack tools operate during agent invocation and do not ingest tool I/O into managed RAG by default
...
### Requirement: [CFHA-REQ-SLACK-TOOLS-002] Slack tools credentials are distinct from Slack scraper credentials
...
### Requirement: [CFHA-REQ-SLACK-TOOLS-003] Agent can acknowledge and respond via reactions, posts, and updates
...
### Requirement: [CFHA-REQ-SLACK-TOOLS-004] Agent can fetch bounded channel or thread history
...
### Requirement: [CFHA-REQ-SLACK-TOOLS-005] Slack Web API access uses slack_sdk consistent with other Slack integrations
...
### Requirement: [CFHA-REQ-SLACK-TOOLS-006] Secrets are never written to logs or metrics labels on the tools path
