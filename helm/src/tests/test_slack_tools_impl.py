...
from hosted_agents.tools_impl.slack_support import _slack_req_id_from_headers
...
def test_slack_post_real_calls_chat_post_message(
    ...
    with patch("hosted_agents.tools_impl.slack_support.WebClient") as wc:
...
def test_tools_impl_has_no_embed_client_import() -> None:
    ...
    import hosted_agents.tools_impl.slack_chat_and_history as sch
    import hosted_agents.tools_impl.slack_post as sp
    import hosted_agents.tools_impl.slack_reactions as sr
