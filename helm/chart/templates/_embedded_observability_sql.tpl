{{/* DDL bundled for library charts: .Files resolves to parent application chart, not this library. */}}
{{- define "declarative-agent-library-chart.embedded.observabilitySql" -}}
